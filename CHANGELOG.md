...
- **New brand: NOVUS — 29 cameras** (AHD analog), from the 2016 NOVUS AHD ShortForm catalogue: `NVAHD-*` 1MP/2MP domes/bullets/box + 10×/20× analog speed domes (Sony/Aptina/Panasonic sensors). `connectivity: ["coax"]`, empty `protocols`, no `configs`.
