...
- **New brand: Ganz — 52 cameras** (CBC Group), from the 2018–19 catalogue: PixelPro IP domes/bullets/box/turrets/fisheye (`ZN-*`/`ZN8-*`/`ZN1A-*`, 1080p–6MP, P-Iris, True WDR, motorised) plus 12×/30× GenStar PTZs, and nine analog HD/CVBS domes (`ZC-*`, 600–700 TVL, Sony HAD-II CCD, coax). *(A set of newer GenStar/PixelPro per-model datasheets is queued to extend & supersede the catalogue entries.)*
