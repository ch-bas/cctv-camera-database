...
- **Honeywell 35 Series — +~24 cameras**, from official 35S datasheets (prod-edam.honeywell.com): dual-light color bullet/ball (`HC35CB5R3`/`HC35CE5R3`), WDR bullets (`HC35WB*`) & turrets (`HC35WE*`) 2–8 MP, micro/WDR domes (`HC35W25R3*`/`HC35W4*`), motorized-zoom bullets (`HC35WZ*`), 6/12 MP fisheyes (`HC35WF6R1`/`HC35WFCR1`) and the `HC35WMBAR1` 180° dual-sensor panoramic. Hikvision-OEM (RTSP `/Streaming/Channels/101`); H.265/H.264/MJPEG, ONVIF G/S/T/M, microSD to 1 TB, IP67/IK10.
