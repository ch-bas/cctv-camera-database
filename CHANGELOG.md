...
### Added
- **New brands: Hiseeu (7) + Srihome (1) + IMILAB (1)** (#268) — budget Wi-Fi cameras from the manufacturer/retailer listings: Hiseeu `TZ-HBY08` (8 MP 4K bullet), `C90B` (4 MP solar), `WHD205`/`WHC905`/`WHD315` (5 MP PTZ/PT), `WHD308B` (8 MP 4K PTZ), `WTDS803` (6 MP solar dual-lens); Srihome/Sricam `SH057` (4 MP starlight, H.265); IMILAB `C21` (4 MP 2.5K indoor PTZ, Xiaomi ecosystem). Frigate RTSP configs from the #268 RTSP-patterns layer (Hiseeu `/live/main`@80, SriHome `/1/h264major`); solar/battery + indoor-cloud models (C90B, WTDS803, C21) are app/cloud cameras with no local RTSP.
