...
### Added
- **New brand: IC Realtime — 35 cameras** (US, Dahua-OEM), from the IC Realtime catalogue: Edge (`IPEG-*`) and Max (`IPMX-*`) 2/4MP IP bullets/domes/turrets (fixed + varifocal, IR + warm-light full-colour + active-deterrence), Elite (`IPEL-*`) 4K/8MP including 185°/180° fisheyes, a 4×2MP multi-sensor, a dual-lens and up to 40× IR PTZs, a `THIP-*` thermal/visible bispectral bullet, plus HDAVS/coax analog (`ICR-*`/`AVS-*`/`HDEL-*`) LPR & panoramic models. IP → ONVIF/RTSP + H.265/H.264; analog → `coax`. Accessory mounts (`MNT-*`, listed as MPA/MPB) correctly skipped.
