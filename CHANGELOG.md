...
- **ZOSI +30** — consumer PoE / WiFi / battery-solar / analog cameras.
- **TOGUARD +25** — consumer WiFi / solar / PoE cameras and doorbell.
- **Verint FSS +17** — enterprise IP cameras.
- **BESDER +16** — WiFi / 4G / solar PTZ, bullet and bulb cameras.
- **Nooie +6** — consumer WiFi cameras (360 pan-tilt, indoor, pro, baby).

### Added — existing-brand catalogue expansion (+5,397)
Deep gap-fills across ~95 already-covered brands, each from the manufacturer's official product pages and datasheets (real specs only; no fabrication):

- **Intelbras +459**, **Mapesen +376**, **Hikvision +303**, **TVT +288**, **Vivotek +269**, **Uniview +249**, **Sunell +235**, **Comelit +190**, **Dahua +144**, **RVi +135**, **i-PRO +133**, **Alibi +129**, **Beward +120**, **Speco +105**, **Hi-Focus +95**, **LTS +90**, **Longse +89**, **ACTi +86**, **Amcrest +70**, **Grundig +68**, **TRASSIR +64**, **Tiandy +57**, **Digital Watchdog +54**, **Matrix +52**, **Axis +50**, **Bolide +50**, **Hanwha +50**, **Prama +47**, **Dallmeier +43**, **EZVIZ +43**, **Avycon +41**, **GeoVision +40**, **Jovision +40**, **CP PLUS +38**, **Vitek +38**, **Ganz +37**, **Infinova +37**, **Honeywell +35**, **Illustra +35**, **D-Link +34**, **Foscam +34**, **Avtron +32**, **Vicon +32**, **VIGI +32**, **Vikylin +31**, **eneo +30**, **Hiseeu +30**, **JideTech +29**, **Lorex +29**, **Uniarch +29**, **FLIR +26**, **HiLook +26**, **Swann +25**, **VStarcam +25**, **Tapo +24**, **Costar +23**, **Night Owl +22**, **HIKMICRO +21**, **Sannce +21**, **Zmodo +20**, **ANNKE +19**, **IDIS +19**, **SriHome +18**, **ABUS +17**, **ClareVision +15**, **Eagle Eye Networks +15**, **Kedacom +15**, **Kenik +15**, **Ring +15**, **Verkada +15**, **Milesight +14**, **Novus +14**, **Bosch +13**, **OpenEye +13**, **INSTAR +12**, **ieGeek +11**, **Anpviz +10**, **Avigilon +10**, **Cisco Meraki +10**, **Wansview +9**, **ESP +7**, **Imou +7**, **eufy +6**, **Pelco +6**, **Ubiquiti +6**, **Blink +5**, **Wyze +5**, **Arlo +3**, **Xiaomi +3**, **Boavision +2**, **Galayou +2**, **Kasa +2**, **Homaxi +1**, **LaView +1**, **MOBOTIX +1**, **Reolink +1**, **Sparsh +1**.
- Camera families span bullet, dome, turret, PTZ (with auto-tracking where applicable), fisheye/panoramic, multi-sensor, thermal/bi-spectrum, explosion-proof, ANPR/LPR, active-deterrence, doorbell, and HD-analog lines. Cross-brand OEM duplicates (e.g. Arecont ConteraIP model numbers shared across Arecont Vision / Costar / IDIS) were de-duplicated by normalized model number.
...
### Added — Cohu (new brand) + Bosch AutoDome + Axis (+12)
- **Cohu (new brand, +3):** 3950 iVIEW, 3960 (3964/3965 variants) and 3920 iDome (3923/3925) — analog traffic PTZ camera/positioner systems (1/4" CCD, 470 TVL, 23x zoom, day/night, NEMA TS2, IP67). Modeled as `connectivity: ["coax"]` with no `configs`; their datasheets publish no field-of-view in degrees, so `field_of_view_deg` is deliberately absent rather than computed.
- **Bosch AUTODOME (+5):** AUTODOME IP starlight 7000i (NDP-7512-Z30), AUTODOME IP starlight 7000 HD, AUTODOME IP dynamic 7000 HD, and the VG4 modular AutoDome 300 + 500i series — each from the official Bosch datasheet with real FOV, lens, sensor, and sensitivity.
- **Axis (+4):** Q6155-E and Q6054-E (PTZ speed domes), plus Q6000-E Mk II and P3707-PE (typed `panoramic` — 4-sensor 360° overview and 4-sensor multidirectional). From `axis.com` datasheets.
- Model aliases carry each vendor's registry spellings (e.g. `VG4 AUTODOME H.264`, `3925 Dome`, `VG5-836`) so public-catalogue deployments resolve to the right record.

### Added — model-enrichment extract + tooling
- **`data/model-enrichment.json`** — a slim, endpoint-free CC0 projection of the dataset (id, brand, model, aliases, type, spec-page URL, FOV, resolution, PTZ, night vision, NDAA) for external viewers that enrich *identified* camera hardware. Regenerated by the new **`scripts/gen-model-enrichment.js`**. Excludes sources, configs and RTSP data by design — it describes camera products, not installations.

### Changed — IC Realtime Frigate configs (#170)
- Backfilled `configs.frigate` on **47 legacy IC Realtime IP records** (Dahua-OEM `/cam/realmonitor` scheme) that shipped without one.
...
- **New brand: Infiniti Optics — 62 cameras** (Infiniti Electro-Optics, Canada), long-range surveillance: **VIS-NIR** motorized-zoom modules (17, up to 61x/95x optical, 3-33MP, fog/heatwave mitigation, EIS), **thermal** LWIR uncooled + MWIR cooled InSb/X-Hot fixed & zoom cores (30, 640x512-1920x1080 detectors, Johnson-DRI ranges), and **PTZ positioner systems** (7 - Triton/Atlas/Neptune/Eclipse/Sentry/Leos/Vega, configurable visible/thermal/ZLID payloads). From the VIS-NIR + Thermal + 2021 catalog brochures. (Illuminators/lenses/positioner-only tiers excluded.)
- **New brand: Sunell — 155 cameras** (Sunell Technology, China): 12MP/8MP IPV turrets/domes & IPR bullets (dual-light active-deterrence + IR, WDR, IP66/67, microSD to 1TB) from official datasheets, IPC ANPR/box cameras, IPD domes, IPS/IPT PTZ speed domes (up to 40x, anti-corrosion 316L/IP68), IPV 4/8MP WDR domes, IPV8088 fisheye, CHP explosion-proof PTZs, and the full TPC/TPH/TPT/TPS thermal + radar-linked thermal-PTZ lineup — from the Sunell Selection Guide + per-model datasheets. (Selection-guide family-wildcard SKUs and mount accessories excluded.)
...
- **GeoVision +12** — new 2026 DM models: BX box, EBDP/TBLP 180° panoramic, GPH pinhole, LPC/LPR ANPR + AI-cloud bullets/domes. (20+ GV access-control readers in the DM correctly excluded.)
- **New brand: TRUEN — 20 cameras** (Truen Co., South Korea), IP cameras & long-range zoom PTZ from the TRUEN datasheet: TN-B/D boxes/domes/bullets (2MP, up to 18x), TN-P/TX-P AI laser-IR speed-dome PTZs (30x/36x/40x, IR to 300-400m, PoE++/AC24V, IP66/IK10, auto-tracking), and TCAM visible-light bullets/domes. H.265/H.264/MJPEG, ONVIF.
- **New brand: Illustra — 60 cameras** (Johnson Controls / Tyco), the full **Pro Gen4/Gen5**, **Flex Gen4** and **Essentials Gen4** IP lineup from official A&E/datasheets: bullets, mini/compact domes, fisheye, corner/anti-ligature (IK11/IP68), multisensor & PTRZ multisensor (up to 32MP), dual-sensor, stitched panoramic (Gen5 15MP, 188°), LPR, and indoor/outdoor 30×/35× PTZs. H.265/H.264/MJPEG + IntelliZip smart codec, ONVIF, PoE. (Datasheets are behind a PerimeterX bot-wall — retrieved via the WebFetch fetcher.)
- **New brand: Panasonic — 3 cameras** (Panasonic MEA surveillance line): `PM-EB4UKFC-W` (4MP dual-light IR+white bullet) and `PM-EB6ULFC-W`/`PM-EB8ULFC-W` (6/8MP full-colour white-light bullets), 1/2.7"–1/3" CMOS, H.265+/H.264+ down to H.264/MJPEG, built-in mic, PoE 802.3af, IP67. From the Panasonic MEA spec sheets.
- **New brand: Vicon — 24 cameras** (Vicon Industries, US), the current **Roughneck** IP line from official info.vicon-security.com datasheets: AI bullets & domes (`V2002/2005/2008 B/D`, 2/5/8 MP, True WDR 120dB, Starlight, IR 40m, IP67/IK10, object classification), micro-dome/corner/anti-ligature V-CELL, a 4K box, 30×/35× IR PTZs (auto-tracking, IR to 400m), 20/32 MP multi-sensor, a 12 MP 360° fisheye and 8 MP LPR bullets/box. H.265/H.264/MJPEG, ONVIF, PoE+/++. Legacy analog (V9xx, no MP) and accessories excluded.
- **New brand: ZKTeco — 35 cameras** (ZKiVision video line), transcribed via vision-OCR from the image-based ZKiVision catalogue: the IP line — `ZKIR` weatherproof IR bullets, `ZKMD` domes, `ZKIP` boxes/cube, `ZKMD` mini-domes and `ZKSD` high-speed-dome PTZs (720p H.264, WDR variants, microSD, PoE) — plus the legacy analog CCD range (`ZK-SIR` dot-matrix/array IR bullets, `ZK-SMD` mini IR domes, `ZK-SSD` 4.5"/6"/9" speed domes, TVL/coax). Values read from the catalogue spec tables; illegible fields omitted.
- **New brand: Grundig — 76 cameras** (Grundig Security, Germany), from the Grundig 2024 Product Guide: the **GD-CI** IP line (boxes, turrets, fixed domes, bullets, 4–42× PTZ speed domes, a 12MP fisheye and 8160-px multi-imager panoramic — 2–8 MP, 1/2.8"–1/1.8" CMOS, H.265pro+/H.265/H.264, Starlight low-light to 0.001 lux, IR to 500m), the **GD-TI** bi-spectrum & thermal-only bullets/domes, and the **GD-CT** HD-analog TVI domes/bullets/box/PTZ (coax). Spec-column-verified; brackets (GD-BR)/recorders/keyboards/lenses excluded.
- **New brand: eneo — 26 cameras** (Videor E. Hartig GmbH, Germany), from the eneo 2025 product brochure: `INB` bullets & `IND` domes (2/5/8 MP, Sony STARVIS / OmniVision / SmartSens sensors, True Day&Night + 24h-Colour), `INP` PTZ (incl. 33× optical), `INT` optical/thermal hybrid, and `INM`/`INB` 360°/180° panoramic multisensor. H.265/H.264, ONVIF/RTSP; sensor chip, resolution, fps and min-lux read from the per-model spec columns.
- **CP Plus — +40 cameras** (Aditya Group, India; existing brand 26→66), from the CP Plus Product Portfolio 2025-26 catalogue: `CP-UNC-*` illumax IP network domes/bullets/turrets/wedge/box (2.4–8 MP, IR + Dual-Light, Starlight, WDR 120dB), a `CP-UNP-F4521` 45× PTZ, a `CP-UNC-TT41` ANPR camera, plus `CP-URC-*` HDCVI analog domes/bullets (2.4/5 MP, coax) and `CP-UMC-*` HD two-way-audio coax cameras. Brochure-verified specs; recorders/switches/racks/cables/accessories excluded.
- **New brand: Dallmeier — 30 cameras** (Dallmeier electronic, Germany), from the official Download Centre datasheets: the **Panomera** multifocal-sensor systems — S4/S8 Area & Stadium (33–304 MPe) and W4/W8 Area wide-angle (45/95 MPe, 180°/360°×90°), plus the V8 Area — all UWDR 130 dB, Deep-AI EdgeAnalytics, ONVIF M/S/T, IP69 with heater, 48 V DC/PoE, Domera OS; the **RDF** Remote-Positioning-Dome line (`RDF6120/6140DN` 2/5 MP, `RDF6400/6800DN` 4/8 MP — motorized PTRZ, P-Iris); the **DDF6050DN** Picoline 5 MP domes (fixed + varifocal); and the **SDF6800DN** 8 MP 360° fisheye. (Airport variants + the pre-Domera legacy generations were left out — no reachable current datasheet.)
- **Honeywell 60 Series — 28 cameras** (new-to-dataset high-tier line, prod-edam datasheets): AI + non-AI indoor/outdoor domes (HC60W3x/W4x), AI + non-AI bullets (HC60WB), a box (HC60WC5I), a 12MP fisheye (HC60WFCR1-V) and 2/4/5/8MP 30–40× ultra-low-light IR speed-dome PTZs (HC60WZ, IR to 500m, auto-tracking). Hikvision-OEM; H.265/H.264/MJPEG, ONVIF, PoE++/UPoE.
- **Honeywell 35 Series — +~30 cameras**, from official 35S datasheets (prod-edam.honeywell.com): dual-light color bullet/ball (`HC35CB5R3`/`HC35CE5R3`), WDR bullets (`HC35WB*`) & turrets (`HC35WE*`) 2–8 MP, micro/WDR domes (`HC35W25R3*`/`HC35W4*`), motorized-zoom bullets (`HC35WZ*`), 6/12 MP fisheyes (`HC35WF6R1`/`HC35WFCR1`) and the `HC35WMBAR1` 180° dual-sensor panoramic. Hikvision-OEM (RTSP `/Streaming/Channels/101`); H.265/H.264/MJPEG, ONVIF G/S/T/M, microSD to 1 TB, IP67/IK10.
- **Comprehensive spec backfill across 15 brands** (verified-datasheet-only, no speculation) — filled `network.ethernet_speed_mbps`, `power.consumption_w`/`voltage`, `weight_g`, `dimensions_mm`, `operating_temp_c`, `storage.max_microsd_gb`, `night_vision.min_lux`, `sensor`/`codecs`/`lens`/`audio`/`features` from each model's official datasheet: Comelit, Eagle Eye Networks, Oncam, Bolide, IC Realtime, LILIN, Avycon, Luminys, Provision-ISR, Linovision, Arecont Vision, Ganz, InVid, i-PRO, NOVUS. Unreachable/defunct-vendor datasheets left as-is rather than sibling-inferred.
- **New brand: OpenEye — 27 cameras** (US, NDAA-compliant; openeye.net), from the OpenEye Product Line brochure + per-model A&E spec sheets (portal.openeye.net). The **C-series** (`OE-C*`, 20 models): 2–8MP fixed & motor-varifocal domes/turrets/bullets (`-S` low-profile line, active-deterrence white-LED + siren), an `OE-C8312P2` 40× IR PTZ, `OE-C9112F12` 12MP fisheye and `OE-C9912M20` 20MP multi-sensor panoramic. The **CC-series** (`OE-CC*`, 7 models): OpenEye Web Services cloud-managed domes/turrets/bullets/fisheye with high-capacity onboard microSD/SDXC (1.5–3TB). H.265/H.264/MJPEG, ONVIF/RTSP, PoE. Sensor/codecs/FPS/audio/onboard-storage/network filled from the spec sheets; lux and PoE class left empty where OpenEye publishes none (never guessed).
- **New brand: Luminys — 58 cameras** (Luminys Corp, US NDAA), the N2–N5 IP range: turrets/domes/bullets (N*T/N*D/N*B), a wedge box (N3W) and a 180° stitched dual-sensor panoramic (N5P), 4–12MP, with LumiLuxSmart (IR + white hybrid), LumiColor (24/7 full-colour white-light), LumiNightKing and LumiDeterrent (active-deterrence) variants. H.265/H.264, ONVIF/RTSP. Datasheets resolved via each product page's datacenter.luminyscorp.com blob.
- **New brand: Linovision — 13 cameras** (US): 4G/LTE units — a 4K dual-lens 180° panoramic (IPC7P8AI-CSL), 25×/30× IR PTZs (IPTZ544D-25X, 4GPTZ-M4, 4GPTZ-Portable230AI), plus PoE IPC7A27/IPC7A47 ANPR/LPR bullets, an IPC534AI-CSL ColorVu turret and an IPC-TO56C-A3 thermal/optical bi-spectrum bullet.
- **New brand: LILIN — 110 cameras** (Merit LILIN, Taiwan), from the 2025 + 2020 IP catalogues. 2025: Z7R/Z6R/S7R/S8R **PTZ speed domes** (2–8MP, 2×–40× optical + laser-IR to 800m, NEMA-4X variants), V1W **bullets** & V1R **domes** (4K/5MP, motorized/fixed, EDGEFENCE AI), and E5R **box** cameras. Plus the 2020 line: Z2R/Z3R/Z5R zoom cameras, P2R/P3R/P5R turrets/domes/bullets, P2G box and an F2R 185° fisheye. H.265/H.264, ONVIF/RTSP.
...
- **New brand: InVid Tech — 39 cameras** (US; Hauppauge NY — markets US/LATAM/Africa), from official InVid spec sheets across its house lines: **Secure** & **Vision** IP (`SECA-`/`VIS-` 4/8MP turret/bullet + 160° dual-sensor panoramic), **Paramont** IP (`PAR-P12*` 12MP AI dome/bullet) and **Paramont/Elevate** HD-analog TVI/AHD (`PAR-*`/`ELEV-*` 2–8MP bullets/domes, 4-in-1), plus the InVid-branded **Milesight-OEM** range (`INVID-MS-*`/`INVID-TS-*`): AI turrets/domes/bullets/fisheyes (2–12MP), 12×–42× IR PTZs, road-traffic/LPR bullets and multi-sensor panoramics. IP → ONVIF/RTSP + H.265/H.264; analog → `coax`.
- **New brand: IC Realtime — 59 cameras** (US, Dahua-OEM), from the IC Realtime catalogues (two editions): Edge (`IPEG-*`) and Max (`IPMX-*`) 2/4MP IP bullets/domes/turrets (fixed + varifocal, IR + warm-light full-colour + active-deterrence), Elite (`IPEL-*`) 4K/8MP including 185°/180° fisheyes, a 4×2MP multi-sensor, a dual-lens and up to 40× IR PTZs, a `THIP-*` thermal/visible bispectral bullet, plus HDAVS/coax analog (`ICR-*`/`AVS-*`/`HDEL-*`) LPR & panoramic models. IP → ONVIF/RTSP + H.265/H.264; analog → `coax`. Accessory mounts (`MNT-*`, listed as MPA/MPB) correctly skipped.
- **New brand: HOLOWITS — 1 camera** (Huawei Machine Vision spinoff): `HWT-M2141-10-ELI-S` 4MP AI bullet, 1/1.8" CMOS, 2.8–12mm varifocal + 4× optical zoom, 120 dB WDR, 1-TOPS AI, IR 50m, microSD 256GB, IP67.
- **New brand: Comelit — 41 cameras**, from the Comelit CCTV catalogue (Italian): the **Next** IP series (`IP[BT]CAMN` 4/8MP bullets & turrets, incl. ColorUP white-LED full-colour), the **Advance** series (`IP[BTKDF]CAMA` bullets/turrets/box/domes/12MP fisheye/multi-imager, True WDR, DVA deep video analysis, H.265+), five IR PTZs (`IPPTZA` 4×–40× optical, 150–350m IR, auto-tracking), ANPR/LPR bullets (`IPLPRA`, 60fps HFR + Wiegand) and Wi-Fi cams (`WI…CAM`, incl. a solar dual-light bullet). ONVIF S/G; H.265+/H.265/H.264; no `configs`.
- **New brand: Ganz — 72 cameras** (CBC Group). From the 2018–19 catalogue: PixelPro IP domes/bullets/box/turrets/fisheye (`ZN-*`/`ZN8-*`/`ZN1A-*`, 1080p–6MP, P-Iris, True WDR, motorised) plus GenStar PTZs and nine analog HD/CVBS domes (`ZC-*`, 600–700 TVL, Sony HAD-II CCD, coax). Extended and superseded with newer per-model GenStar/PixelPro datasheets: the `ZN8-2P5X30DL-H` 30× dual-sensor PTZ, `ZN8-4D6DTMZ71` 4-directional multi-sensor, `ZN8-2D8WTFN3` 180° panoramic, `ZN8-80F12F18NL` 12MP fisheye, five `ZNT8-B1F*` thermal bullets, `ZN1A-D4/D6DTMZ56U`, `ZN-VD5/VD8` 4K vandal domes and the `Z8-*-2` 4-in-1 analog domes.
- **New brand: BCS — 56 cameras**, from the 2018 BCS Point catalogue (Polish; IP "BCS-P" line): 4-in-1-free pure-IP bullets, domes, turrets, box (C/CS-mount 12MP/2MP), 185° fisheyes and 20×–44× IR speed-dome PTZs (2–12 MP, H.265/H.264, WDR 120dB, SONY Starvis/Starlight). Extracted from the Polish spec tables (Przetwornik/Obiektyw/Kompresja/Zasięg IR); NVRs/switches/accessories and the back-of-catalogue index skipped.
- **New brand: Bolide — 9 cameras**: five IP PTZs (`BN1009PTZM`/`BN1029PTZMINI`/`BN1009-PTZ-5.0WP`/`BN1009PTZ-5MP`/`BN1009PTZ4K`, 10×–40× optical, up to 4K/37× with active deterrence) and four 180° panoramic turrets/bullet (`BN8109-PN`/`BN9109-PN`/`BN9109-PN-DUAL` dual-sensor/`BN9135-PN`). NDAA-compliant; datasheet-verified (local PDFs + product pages).
- **New brand: Eagle Eye Networks — 25 cameras** (cloud/Bridge-managed IP), from the official EEN/Brivo datasheets: Pro-series `PB`/`PD` bullets & domes and `PT` turrets; `DB` bullets (incl. `DB14` 8–32mm LPR), `DD` domes, `DT` turrets, `DM08` mini-dome, `DF04` 12MP fisheye, `DX01`/`DX02` multi-imager panoramics (dual + 4×5MP), and `DZ05`/`DZ06` 5×/30× PTZs. H.265/H.264/MJPEG; RTSP (ONVIF Profile S where the sheet states it); warm-white "full-colour" illuminators noted in features.
- **Avycon +13**: 12 NX-series cameras (`AVC-NX` 4MP & 8MP turrets/bullets/vandal-domes, InfiniteColor + full-AI + active deterrence, 1/1.8" ultra-low-light, IP67; specs read from the live product pages) plus the `AVC-SNDB41M-4G` solar/4G/WiFi bullet (60W panel, 4×Li battery, microSD 512GB).
- **New brand: AVYCON — 140 cameras**, from the 2025 AVYCON Product Guide. **103 IP** (`AVC-N*`): AI-series turrets/bullets/domes (4/5/8MP, InfiniteStar low-light + InfiniteColor + active-deterrence lines), 25×/33×/37× IR PTZs (`AVC-NSZ*`), 16–32MP multi-sensor panoramics (`AVC-NCMS*`), 180° dual-imager panoramics and 12MP fisheyes — ethernet + PoE/DC12V, H.265/H.264, ONVIF. **37 HD-analog** (`AVC-T*`): 4-in-1 TVI/AHD/CVI/CVBS switchable domes/bullets/turrets (2/5/8MP, `connectivity: ["coax"]`, empty `protocols`). No `configs` (the guide lists no RTSP paths). Thermal models were left for a dedicated pass. The "B/W: 0 lux (IR LED on)" spec is a sentinel → recorded as IR night vision, never as `min_lux: 0`.
- **Arecont Vision +79** from the official product matrix (all-IP megapixel cameras, extending the brand from 10 to 89): **MegaVideo** boxes (`AV1115V1`…`AV10215PM-S`, 1.3–10MP), **MicroDome** (`AV1455DN`…`AV5555DN`), **MegaView** bullets (`AV1125`…`AV10225`, IR), **MegaBall** turrets (`AV1145`…`AV5245PM`), **MegaDome** (`AV1255PM`…`AV10255`), and **SurroundVideo/omni** multi-sensor panoramics (`AV5585PM`…`AV40185`, 5–40MP across 4 imagers, 180°/360°). H.264+MJPEG; `connectivity: ["ethernet"]`, `power_source: ["poe"]`; no `configs` (matrix lists no RTSP path). Values transcribed column-by-column from the spec matrix; blank cells left empty, never inferred from model numbers.
- **New brand: ESP — 12 cameras** (UK). From the 2015 HDview catalogue: 9 `HDVC*` 720p HD-over-coax analog bullets & domes on 1/3" Sony CMOS, fixed 3.6mm and varifocal (2.8–12/5–50/6–22mm) optics, IR to 50m, IP66, D-WDR/ATR/2D+3D-NR (`connectivity: ["coax"]`, empty `protocols`, no `configs`). Plus 3 current **Rekor IP** 2MP PoE cameras from their datasheets — `RC228BB`/`RC228BW` 2.8mm bullets (black/white) and `RC228TW` turret, all 1/2.8" 1080p30, dual-light (IR + white light, 30m), ONVIF Profile S/G/T, microSD to 512GB, IP67.
- **New brand: Siemens — 6 cameras** (legacy Siemens Building Technologies fixed-dome range): `CFFC/CFVC/CFVS/CVVC/CVVS1317` 540 TVL and `CVWC1325` 500 TVL Pixim, 1/3" CCD/CMOS, monofocal 3.7mm and auto-iris varifocal domes, day/night ICR on the S-models, IP66 vandal on the V-models. Analog → coax; empty `protocols`; no `configs`. (The spec-less hybrid `CCIS1337` was left out rather than carry a placeholder resolution.)
- **NOVUS +135** — the full NVIP IP line (existing brand 29 -> 164): 2-12MP bullets/domes (WL/LITE, AI Night Colors), 25x/32x IR speed domes (NVIP-8SD), a 12MP zoom bullet, an LPR bullet (NVIP-2H-6732M), and four NVIP-H-85xx thermal bullets (uncooled microbolometer, 15/25/35/50mm). Full specs incl. weight/dimensions from novuscctv.com product pages. Original 29:, from the 2016 NOVUS AHD ShortForm catalogue: `NVAHD-*` 1MP/2MP domes/bullets/box + 10×/20× analog speed domes (Sony/Aptina/Panasonic sensors). `connectivity: ["coax"]`, empty `protocols`, no `configs`.
- **New brand: DITS Vision — 34 cameras** (Indian; image-only catalogue → vision-OCR): 16 AHD analog (`DV-A*`/`DV-K*`, incl. full-colour white-LED "Dark" series) and 18 IP/WiFi (`DVC-*` PoE bullets/domes 3/4/5 MP with H.265, plus WiFi pan-tilt/fisheye). Analog → coax; IP → ONVIF configs.
- **Bosch +15** from official 4000i/6000i datasheets and the 2016 Sensor Security guide: FLEXIDOME IP indoor/outdoor 4000i (`NDE`/`NDI-4502-A/AL`), FLEXIDOME starlight 6000 (`NIN-63013/63023-A3`), IP bullets 4000i/5000i/6000i (`NBE-4502/5503/6502-AL`), FLEXIDOME indoor 5000i (`NDI-5503-A/AL`), micro 5000 domes (`NUC-51022-F4`, `NUC-52051-F0` fisheye), AUTODOME 5000i (`NDP-5502-30`) and MIC starlight 7000i (`MIC-7230-B5`). (The 2018 Bosch "Product Technology Catalogue" was pure marketing — nothing buildable.)
...
- **New brand: JideTech — 38 cameras**, authored from official JideTech product pages + datasheets (jidetech.com). PoE ONVIF IP cameras across five lines: WiseISP **ColorHunter** full-color fixed turret/bullet/dome (`DM3624-WP`, `BC10`, `DM15`, `BL3238-8MP`, `BL2318-8MP`, `BL2B28-8MP-AI`, `BC2318-WP`, `BC2V-12MP` 12 MP, `IPC3634ZP`); **170–180° wide-angle dual-lens** panoramic (`BC7-4MP-DL`, `BC7-8MP-DL`, `DM12`); **WiFi PTZ** zoom cameras (`P1`/`P2`/`P5 Plus`/`P10`/`P22` families, 4×–36× optical, several with humanoid auto-tracking); **PoE high-speed absolute-positioning PTZ** speed domes (`P22-30X/36X-8MP`, `P22-30X-12MP`, `P10-20X-8MP`, `P2-20X-8MP`, `P23`, `P25`, `P15-30X-5MP`, up to 500 m IR); and **AI face-recognition** cameras (`A3238`, `A268`, `P12`, `P16`, `P15 Plus`). All carry `rtsp` + `onvif` (NVR-compatible); optical zoom is captured in `features` (never a lens-zoom field). Datasheet-verified; unstated fields omitted.
- **New brand: EverFocus — 16 cameras**, authored from official EverFocus datasheets (everfocus.com). 11 PoE ONVIF IP cameras — `EZN`/`EHN`/`EBN` 2 MP/5 MP bullets & domes, `EFN1980` 12 MP fisheye, `EMN2560` 5 MP mini-dome (rtsp + onvif, IP66, IK10 on the vandal domes) — and 5 `EZA`/`EBA`/`EHA` **analog** AHD/TVI/CVI/CVBS switchable-output cameras (coax, DVR-connected, no RTSP/ONVIF; `EZA1281` is dual-power 12 V DC / 24 V AC). Datasheet-verified; unstated fields omitted.
- **New brand: AvertX — 8 cameras**, from official AvertX datasheets (avertx.com): professional NDAA-compliant PoE ONVIF IP cameras — 4 MP & 4K bullets and domes (`C2212B4`, `C2214B4`, `C3212D4-S`, `HD354IR`, `HD448`, `HD458`, `HD848`) and a 12 MP `HD9112F12` 180° fisheye. `rtsp` + `onvif`, IP66/IP67, True WDR, motorized-varifocal on several. Datasheet-verified; unstated fields omitted.
- **New brand: 3xLOGIC — 31 cameras**, from official 3xLOGIC datasheets (compare.3xlogic.cloud). The **VISIX VX** professional PoE ONVIF line: 5 MP bullets (`VX-5M`/`5M20`/`5M650`/`5M622`/`5M4`, incl. `VX-5M-OB-CL` full-color and `VX-5M20-B-RIAL` license-plate), 2/5/8 MP domes (`-ID`/`-OD`/`-MD`), turrets (`-OT`, incl. `VX-5M-OT-CL` ColorLux), 6/12 MP 360° fisheye + 8 MP 180° panoramic, 20 MP `SURROUND` 4-sensor multisensor, 10 MP `DUAL` and `VX-VT-56-DUAL` (thermal + visible) dual-lens, a 30× `VX-2S-OP-30X` PTZ, a `VX-VT` VIGIL thermal, and `VX-SMBK` Small-Business 4 MP bullet/dome — plus 2 `VA-2M` **analog** AHD/TVI/CVI/CVBS coax cameras. NDAA/TAA compliant; regional `-A-C`/`-X` SKU variants merged with aliases. Datasheet-verified; unstated fields omitted.
- **New brand: PIX-LINK — 27 cameras**, from official PIX-LINK product pages (pix-link.com). Budget consumer Wi-Fi cameras: indoor pan/tilt (`RW102P`, `RW206Y`, `JXLCAM`), cube/card/mini cams (`RW101P` Snowman, `RW201T`, `RW204Y`, `FW101P`, `A9`, `A10`), an E27 bulb 360° cam (`DRW125P`), dual-lens security cams (`DRW135P`/`136P`/`137P`), dual-lens solar cams (`DRW341P`/`342P`/`343P-LWF`), and an outdoor 5× PTZ (`A6`). App/cloud (no local RTSP/ONVIF). PIX-LINK publishes specs only as page images, so specs were read from those images (visually); unstated fields omitted.
- **15 new Dahua WizSense cameras** (HFW3449T1 / HFW3849T / HDBW3449 / HDW3449 families), from official Dahua datasheets: 4 MP TiOC active-deterrence bullets `IPC-HFW3449T1-AS-PV-PRO`, `-ZAS-PV`, `-ZAS-PV-PRO`, `-ZAS-PV-PRO-ATC`, `-AS-PV-PRO-ATC` (WizColor 1/1.8″ F1.0, red/blue warning lights, AcuPick; **ATC** = anti-corrosion C5-H / NEMA 4X, the fixed ATC also -40 °C cold-rated); 4 MP & 8 MP dual-illumination motorized bullets `IPC-HFW3449T-ZS-IL`/`-ZAS-IL` and `IPC-HFW3849T-ZS-IL`/`-ZAS-IL` (4K); and Smart-Dual-Light / full-color domes & eyeball `IPC-HDBW3449E-AS-IL`/`-S-IL`/`EP-AS-NI`, `IPC-HDBW3449R-ZS-IL`/`-ZAS-IL` (motorized IK10), `IPC-HDW3449QM-S-IL`.
