...
Dataset reaches **12,279 cameras / 157 brands** (+272). Full **Vivotek** and **Amcrest** catalogue sweeps, a dataset-wide **`network.ethernet_speed_mbps`** backfill from official datasheets, missing **Uniview** and **GeoVision** bullet/dome models, and a round of sourcing/config fixes.
