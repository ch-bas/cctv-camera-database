...
### Added
- **New brand: ESP — 9 cameras** from the 2015 ESP HDview catalogue (UK; HD-over-coax analog): `HDVC*` 720p bullets & domes on 1/3" Sony CMOS, fixed 3.6mm and varifocal (2.8–12/5–50/6–22mm) optics, IR to 50m, IP66, D-WDR/ATR/2D+3D-NR. `connectivity: ["coax"]`, empty `protocols`, no `configs`.
