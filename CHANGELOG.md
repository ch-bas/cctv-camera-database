...
- **New brand: Dallmeier — 8 cameras** (Dallmeier electronic, Germany): the **Panomera** multifocal-sensor systems (`Panomera V8 150/180 DN` 150 MPe, `S8 66/13`/`66/20 DN`/`66/29 DN Stadium` 66 MP — 180° coverage, UWDR, ONVIF M/S/T, IP69 with heater, 48 V DC) and the **RDF** Remote-Positioning-Dome line (`RDF6120DN`/`RDF6140DN` 2/5 MP, `RDF6400DN`/`RDF6800DN` 4/8 MP — motorized PTRZ, P-Iris varifocal, Deep-AI EdgeAnalytics, Domera OS). From the official Dallmeier Download Centre datasheets.
