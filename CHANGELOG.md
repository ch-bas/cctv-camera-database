...
- **New brand: Eagle Eye Networks — 4 cameras** (partial; first wave of a larger set): cloud/Bridge-managed IP `PB01`/`PB02` bullets, `DD07` dome, `DB10` bullet from official EEN datasheets. H.265/H.264. *(~21 more EEN models — PD/PT/DB/DD/DT/DM/DF/DX/DZ series — queued; interrupted by a session limit, to finish next.)*
