...
- **10 new Dahua WizSense 4 MP cameras** (HFW3449T1 / HDBW3449 families), from official Dahua datasheets: TiOC active-deterrence bullets `IPC-HFW3449T1-AS-PV-PRO`, `-ZAS-PV`, `-ZAS-PV-PRO`, `-ZAS-PV-PRO-ATC`, `-AS-PV-PRO-ATC` (WizColor 1/1.8″ F1.0, red/blue warning lights, AcuPick; **ATC** = anti-corrosion C5-H / NEMA 4X, the fixed ATC also -40 °C cold-rated); dual-illumination motorized bullets `IPC-HFW3449T-ZS-IL` / `-ZAS-IL`; and Smart-Dual-Light / full-color domes `IPC-HDBW3449E-AS-IL`, `-S-IL`, `IPC-HDBW3449EP-AS-NI`.
