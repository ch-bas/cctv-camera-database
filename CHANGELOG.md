...
- **NOVUS +15** — the NVIP IP line (existing brand from 29 -> 44): 2-12MP bullets/domes (WL/LITE, AI Night Colors), 25x/32x IR speed domes (NVIP-8SD), a 12MP zoom bullet, an LPR bullet (NVIP-2H-6732M), and four NVIP-H-85xx thermal bullets (uncooled microbolometer, 15/25/35/50mm). Full specs incl. weight/dimensions from novuscctv.com product pages. Original 29:, from the 2016 NOVUS AHD ShortForm catalogue: `NVAHD-*` 1MP/2MP domes/bullets/box + 10×/20× analog speed domes (Sony/Aptina/Panasonic sensors). `connectivity: ["coax"]`, empty `protocols`, no `configs`.
