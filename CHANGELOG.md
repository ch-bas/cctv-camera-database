...
### Added
- **New brand: Sunell — 35 cameras** (Sunell Technology, China): 12MP/8MP IPV turrets/domes & IPR bullets (dual-light active-deterrence + IR, WDR, IP66/67, microSD to 1TB) from official datasheets, IPC ANPR/box cameras, IPD domes, CHP explosion-proof/anti-corrosion PTZs, and a D2P bi-spectrum thermal — from the Sunell Selection Guide + per-model datasheets. (Selection-guide family-wildcard SKUs and mount accessories excluded.)
