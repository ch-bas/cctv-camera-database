...
An open, structured database of 9,218 CCTV / IP camera models and their technical specifications, covering 136 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-9%2C218-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 9,218 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 9,218 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 9,218 cameras as one array |
...
- **Pagination** — page through all 9,218 cameras, 25 per page
...
| PoE wired | 6,622 |
| WiFi | 1,054 |
| Battery / wire-free | 319 |
| 4K / 8MP+ | 2,113 |
| 4–7MP | 3,673 |
| Under 4MP | 3,432 |
| With integration configs (Frigate / Home Assistant) | 6,477 |
...
| Dahua | 807 | Enterprise + consumer, global |
...
│   ├── cameras.json      # all 9,218 cameras as one array
...
- [ ] **Frigate verification drive** — only 28 of 6,402 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
