...
[![cameras](https://img.shields.io/badge/cameras-12%2C344-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 12,344 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 12,344 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 12,344 cameras as one array |
...
- **Pagination** — page through all 12,344 cameras, 25 per page
...
| 4–7MP | 4,904 |
| Under 4MP | 4,811 |
| With integration configs (Frigate / Home Assistant) | 9,059 |
| With color-lux rating (`night_vision.min_lux_color`) | 8,856 |
...
│   ├── cameras.json      # all 12,344 cameras as one array
...
- [ ] **Frigate verification drive** — only 30 of 8,950 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
