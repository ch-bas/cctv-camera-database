...
An open, structured database of 6,288 CCTV / IP camera models and their technical specifications, covering 126 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-6%2C288-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-126-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 6,288 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 6,288 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
- **Pagination** — page through all 6,288 cameras, 25 per page
...
| PoE wired | 4,627 |
| WiFi | 836 |
| Battery / wire-free | 266 |
| 4K / 8MP+ | 1,582 |
| 4–7MP | 2,484 |
| Under 4MP | 2,222 |
| With integration configs (Frigate / Home Assistant) | 4,118 |
...
| Tapo (TP-Link) | 57 | Consumer budget, global |
...
│   ├── cameras.json      # all 6,288 cameras as one array
