...
<p align="center">
  <img src="docs/demo.gif" alt="CCTV Camera Database — browse, search, filter, and inspect 2,718 cameras across 72 brands" width="800" />
</p>
...
- **Pagination** — page through all 2,718 cameras, 25 per page
...
│   ├── cameras.json      # all 2,718 cameras as one array
