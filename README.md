...
An open, structured database of 13,966 CCTV / IP camera models and their technical specifications, covering 164 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-13%2C966-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-164-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 13,966 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 13,966 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 13,966 cameras as one array |
...
- **Pagination** — page through all 13,966 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **13,966** |
| Brands | **164** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 10,224 |
| WiFi | 1,202 |
| Battery / wire-free | 350 |
| 4K / 8MP+ | 3,019 |
| 4–7MP | 5,359 |
| Under 4MP | 5,588 |
| With integration configs (Frigate / Home Assistant) | 10,736 |
| With color-lux rating (`night_vision.min_lux_color`) | 10,062 |

### All 164 brands

<details>
<summary><strong>All 164 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
│   ├── cameras.json      # all 13,966 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~573 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,298 of 10,625 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
