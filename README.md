...
An open, structured database of 1,709 CCTV / IP camera models and their technical specifications, covering 69 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-1%2C709-blue)](data/cameras.json)
...
- **Pagination** — page through all 1,709 cameras, 25 per page
...
│   ├── cameras.json      # all 1,709 cameras as one array
...
| 4–5MP | 722 |
| 1080p–2MP | 469 |
| With integration configs (Frigate / Home Assistant) | 1,294 |
