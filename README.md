...
An open, structured database of 21,573 CCTV / IP camera models and their technical specifications, covering 195 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-21%2C573-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-195-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 21,573 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 21,573 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 21,573 cameras as one array |
...
- **Pagination** — page through all 21,573 cameras, 25 per page
...
<details>
<summary><strong>All 195 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
| ACTi | 798 | Enterprise IP + analog, NDAA, TW/global |
...
│   ├── cameras.json      # all 21,573 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~1,370 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,300 of 16,839 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
