...
An open, structured database of 13,870 CCTV / IP camera models and their technical specifications, covering 161 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-13%2C870-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-161-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 13,870 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 13,870 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 13,870 cameras as one array |
...
- **Pagination** — page through all 13,870 cameras, 25 per page
...
| 4–7MP | 5,307 |
| Under 4MP | 5,581 |
| With integration configs (Frigate / Home Assistant) | 10,649 |
| With color-lux rating (`night_vision.min_lux_color`) | 9,997 |

### All 161 brands

<details>
<summary><strong>All 161 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
│   ├── cameras.json      # all 13,870 cameras as one array
...
- [ ] **Frigate verification drive** — only 1,298 of 10,540 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
