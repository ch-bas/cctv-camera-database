...
An open, structured database of 2,904 CCTV / IP camera models and their technical specifications, covering 74 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-2%2C904-blue)](data/cameras.json)
...
- **Pagination** — page through all 2,904 cameras, 25 per page
...
│   ├── cameras.json      # all 2,904 cameras as one array
...
| 4–5MP | 1,210 |
| 1080p–2MP | 886 |
| With integration configs (Frigate / Home Assistant) | 2,429 |
