...
An open, structured database of 6,938 CCTV / IP camera models and their technical specifications, covering 133 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-6%2C938-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-133-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 6,938 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 6,938 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 6,938 cameras as one array |
...
- **Pagination** — page through all 6,938 cameras, 25 per page
...
| PoE wired | 5,178 |
| WiFi | 933 |
| Battery / wire-free | 285 |
| 4K / 8MP+ | 1,734 |
| 4–7MP | 2,751 |
| Under 4MP | 2,453 |
| With integration configs (Frigate / Home Assistant) | 4,709 |
| With color-lux rating (`night_vision.min_lux_color`) | 4,491 |

### All 133 brands

<details>
<summary><strong>All 133 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
| Dahua | 369 | Enterprise + consumer, global |
...
| Milesight | 146 | Prosumer/Enterprise IoT, global |
| Kenik | 145 | — |
...
│   ├── cameras.json      # all 6,938 cameras as one array
...
- [ ] **Frigate verification drive** — only 28 of 4,663 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
...
```
CCTV Camera Database (v2.13.0), CC0 1.0. https://cctv-database.com — https://github.com/ch-bas/cctv-camera-database
```
