...
An open, structured database of 24,376 CCTV / IP camera models and their technical specifications, covering 211 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-24%2C376-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-211-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 24,376 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 24,376 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 24,376 cameras as one array |
...
- **Pagination** — page through all 24,376 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **24,376** |
| Brands | **211** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 17,468 |
| WiFi | 2,167 |
| Battery / wire-free | 608 |
| 4K / 8MP+ | 4,869 |
| 4–7MP | 9,503 |
| Under 4MP | 10,004 |
| With integration configs (Frigate / Home Assistant) | 19,043 |
| With color-lux rating (`night_vision.min_lux_color`) | 17,026 |

### All 211 brands

<details>
<summary><strong>All 211 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
│   ├── cameras.json      # all 24,376 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~1,579 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,301 of 18,840 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
