...
An open, structured database of 1,901 CCTV / IP camera models and their technical specifications, covering 71 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
- **Pagination** — page through all 1,901 cameras, 25 per page
...
│   ├── cameras.json      # all 1,901 cameras as one array
