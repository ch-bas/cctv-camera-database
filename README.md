...
An open, structured database of 3,854 CCTV / IP camera models and their technical specifications, covering 88 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-3%2C854-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-88-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 3,854 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 3,854 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
- **Pagination** — page through all 3,854 cameras, 25 per page
...
│   ├── cameras.json      # all 3,854 cameras as one array
