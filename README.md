...
An open, structured database of 1,627 CCTV / IP camera models and their technical specifications, covering 69 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-1%2C627-blue)](data/cameras.json)
...
- **Pagination** — page through all 1,627 cameras, 25 per page
...
│   ├── cameras.json      # all 1,627 cameras as one array
...
| Lorex | 18 | Consumer NVR systems, CA/US |
