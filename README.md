...
An open, structured database of 6,331 CCTV / IP camera models and their technical specifications, covering 127 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-6%2C331-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-127-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 6,331 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 6,331 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
- **Pagination** — page through all 6,331 cameras, 25 per page
...
| PoE wired | 4,631 |
| WiFi | 871 |
| Battery / wire-free | 274 |
| 4K / 8MP+ | 1,587 |
| 4–7MP | 2,490 |
| Under 4MP | 2,254 |
| With integration configs (Frigate / Home Assistant) | 4,154 |
| With color-lux rating (`night_vision.min_lux_color`) | 3,912 |
...
| Bosch | 237 | Enterprise + thermal, EU/global |
...
│   ├── cameras.json      # all 6,331 cameras as one array
