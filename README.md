...
An open, structured database of 23,797 CCTV / IP camera models and their technical specifications, covering 206 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-23%2C797-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-206-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 23,797 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 23,797 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 23,797 cameras as one array |
...
- **Pagination** — page through all 23,797 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **23,797** |
| Brands | **206** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 17,087 |
| WiFi | 2,118 |
| Battery / wire-free | 581 |
| 4K / 8MP+ | 4,747 |
| 4–7MP | 9,264 |
| Under 4MP | 9,786 |
| With integration configs (Frigate / Home Assistant) | 18,617 |
| With color-lux rating (`night_vision.min_lux_color`) | 16,851 |

### All 206 brands

<details>
<summary><strong>All 206 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
|-------|---------|---------|
| Hikvision | 2,364 | Enterprise + consumer, global |
| Dahua | 2,231 | Enterprise + consumer, global |
...
| Mapesen | 501 | OEM/budget IP + analog, CN/global |
...
│   ├── cameras.json      # all 23,797 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~1,506 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,301 of 18,414 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
