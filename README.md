...
An open, structured database of 15,689 CCTV / IP camera models and their technical specifications, covering 184 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-15%2C689-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-184-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 15,689 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 15,689 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 15,689 cameras as one array |
...
- **Pagination** — page through all 15,689 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **15,689** |
| Brands | **184** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 11,608 |
| WiFi | 1,370 |
| Battery / wire-free | 407 |
| 4K / 8MP+ | 3,347 |
| 4–7MP | 6,047 |
| Under 4MP | 6,295 |
| With integration configs (Frigate / Home Assistant) | 12,442 |
| With color-lux rating (`night_vision.min_lux_color`) | 11,330 |

### All 184 brands

<details>
<summary><strong>All 184 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
| Milesight | 223 | Prosumer/Enterprise IoT, global |
| Safire | 194 | — |
| LTS | 188 | Prosumer/installer, US |
| Vivotek | 188 | Enterprise AI, global |
...
| Tiandy | 124 | Enterprise + prosumer, CN/ME/Africa |
...
| Sony | 56 | Professional imaging (IPELA), JP/global |
| Avtron | 55 | Enterprise + analog, IN |
| Foscam | 55 | Consumer WiFi/PoE, global |
| Infinova | 50 | — |
| Turing | 49 | — |
| Ubiquiti UniFi | 47 | Prosumer/SMB, US/global |
...
| ESP | 32 | Installer HDview + Rekor IP, UK/EU |
...
│   ├── dahua/            # 1996 cameras
│   ├── hikvision/        # 1859 cameras
│   ├── acti/             # 712 cameras
│   ├── hanwha/           # 662 cameras
│   ├── pelco/            # 567 cameras
│   ├── avigilon/         # 507 cameras
│   └── …178 more brands
├── data/                 # GENERATED — do not edit by hand
│   ├── cameras.json      # all 15,689 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~732 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,300 of 12,331 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
