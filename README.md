...
An open, structured database of 1,633 CCTV / IP camera models and their technical specifications, covering 69 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-1%2C633-blue)](data/cameras.json)
...
- **Pagination** — page through all 1,633 cameras, 25 per page
...
│   ├── cameras.json      # all 1,633 cameras as one array
...
| Lorex | 24 | Consumer NVR systems, CA/US |
