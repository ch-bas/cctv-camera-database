...
An open, structured database of 2,893 CCTV / IP camera models and their technical specifications, covering 74 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-2%2C893-blue)](data/cameras.json)
...
- **Pagination** — page through all 2,893 cameras, 25 per page
...
│   ├── cameras.json      # all 2,893 cameras as one array
...
| 4–5MP | 1,207 |
| 1080p–2MP | 882 |
| With integration configs (Frigate / Home Assistant) | 2,418 |
| With color-lux rating (`night_vision.min_lux_color`) | 1,713 |
