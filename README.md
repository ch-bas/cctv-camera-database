...
An open, structured database of 10,781 CCTV / IP camera models and their technical specifications, covering 136 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-10%2C781-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 10,781 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 10,781 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 10,781 cameras as one array |
...
- **Pagination** — page through all 10,781 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **10,781** |
| Brands | **136** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 7,558 |
| WiFi | 1,117 |
| Battery / wire-free | 335 |
| 4K / 8MP+ | 2,344 |
| 4–7MP | 4,319 |
| Under 4MP | 4,118 |
| With integration configs (Frigate / Home Assistant) | 7,532 |
| With color-lux rating (`night_vision.min_lux_color`) | 7,497 |
...
| Axis | 143 | Enterprise premium, global |
...
│   ├── cameras.json      # all 10,781 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~539 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 29 of 7,423 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
