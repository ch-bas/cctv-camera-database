...
An open, structured database of 14,260 CCTV / IP camera models and their technical specifications, covering 168 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-14%2C260-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-168-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 14,260 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 14,260 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 14,260 cameras as one array |
...
- **Pagination** — page through all 14,260 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **14,260** |
| Brands | **168** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 10,444 |
| WiFi | 1,246 |
| Battery / wire-free | 371 |
| 4K / 8MP+ | 3,087 |
| 4–7MP | 5,480 |
| Under 4MP | 5,693 |
| With integration configs (Frigate / Home Assistant) | 11,030 |
| With color-lux rating (`night_vision.min_lux_color`) | 10,225 |

### All 168 brands

<details>
<summary><strong>All 168 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
│   ├── cameras.json      # all 14,260 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~613 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,298 of 10,919 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
