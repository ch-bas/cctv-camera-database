...
An open, structured database of 6,321 CCTV / IP camera models and their technical specifications, covering 127 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-6%2C321-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 6,321 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 6,321 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
- **Pagination** — page through all 6,321 cameras, 25 per page
...
| 4–7MP | 2,488 |
| Under 4MP | 2,248 |
| With integration configs (Frigate / Home Assistant) | 4,144 |
| With color-lux rating (`night_vision.min_lux_color`) | 3,907 |
...
| Tapo (TP-Link) | 83 | Consumer budget, global |
...
│   ├── cameras.json      # all 6,321 cameras as one array
