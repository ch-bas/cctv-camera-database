...
An open, structured database of 3,455 CCTV / IP camera models and their technical specifications, covering 76 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-3%2C455-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 3,455 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 3,455 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
- **Pagination** — page through all 3,455 cameras, 25 per page
...
│   ├── cameras.json      # all 3,455 cameras as one array
...
| 4–7MP | 1,431 |
| Under 4MP | 1,072 |
| With integration configs (Frigate / Home Assistant) | 2,887 |
| With color-lux rating (`night_vision.min_lux_color`) | 2,213 |
