...
An open, structured database of 7,651 CCTV / IP camera models and their technical specifications, covering 135 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-7%2C651-blue)](data/cameras.json)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 7,651 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 7,651 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 7,651 cameras as one array |
...
- **Pagination** — page through all 7,651 cameras, 25 per page
...
| PoE wired | 5,468 |
| WiFi | 979 |
| Battery / wire-free | 291 |
| 4K / 8MP+ | 1,812 |
| 4–7MP | 3,025 |
| Under 4MP | 2,814 |
| With integration configs (Frigate / Home Assistant) | 5,030 |
| With color-lux rating (`night_vision.min_lux_color`) | 5,100 |
...
|-------|---------|---------|
| Hikvision | 755 | Enterprise + consumer, global |
...
│   ├── cameras.json      # all 7,651 cameras as one array
...
- [ ] **Frigate verification drive** — only 28 of 4,984 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
