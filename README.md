...
An open, structured database of 15,821 CCTV / IP camera models and their technical specifications, covering 185 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-15%2C821-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-185-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 15,821 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 15,821 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 15,821 cameras as one array |
...
- **Pagination** — page through all 15,821 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **15,821** |
| Brands | **185** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 11,696 |
| WiFi | 1,400 |
| Battery / wire-free | 413 |
| 4K / 8MP+ | 3,370 |
| 4–7MP | 6,091 |
| Under 4MP | 6,360 |
| With integration configs (Frigate / Home Assistant) | 12,574 |
| With color-lux rating (`night_vision.min_lux_color`) | 11,389 |

### All 185 brands

<details>
<summary><strong>All 185 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
|-------|---------|---------|
| Dahua | 2,058 | Enterprise + consumer, global |
...
│   ├── cameras.json      # all 15,821 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~737 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,300 of 12,463 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
