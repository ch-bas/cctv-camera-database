...
An open, structured database of 21,406 CCTV / IP camera models and their technical specifications, covering 193 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).
...
[![cameras](https://img.shields.io/badge/cameras-21%2C406-blue)](data/cameras.json)
[![brands](https://img.shields.io/badge/brands-193-green)](cameras/)
...
<p align="center">
  <a href="https://cctv-database.com">
    <img src="assets/cctv-database-showcase.gif" alt="CCTV Camera Database — search 21,406 cameras, browse full specs, copy ready-to-use Frigate configs, and audit the open dataset with the built-in QA tool" width="640">
  </a>
  <br>
  <sub><b><a href="https://cctv-database.com">cctv-database.com</a></b> — search 21,406 cameras · full spec sheets · copy-paste Frigate configs · open &amp; auditable</sub>
</p>
...
|--------|------|----------|
| JSON | [`data/cameras.json`](data/cameras.json) | all 21,406 cameras as one array |
...
- **Pagination** — page through all 21,406 cameras, 25 per page
...
| Metric | Count |
|--------|-------|
| Total cameras | **21,406** |
| Brands | **193** |
| Form factors | 11 (bullet, dome, turret, PTZ, dual-lens, panoramic, covert, box, fisheye, floodlight, doorbell) |
| PoE wired | 15,631 |
| WiFi | 1,886 |
| Battery / wire-free | 536 |
| 4K / 8MP+ | 4,394 |
| 4–7MP | 8,363 |
| Under 4MP | 8,649 |
| With integration configs (Frigate / Home Assistant) | 16,918 |
| With color-lux rating (`night_vision.min_lux_color`) | 15,068 |

### All 193 brands

<details>
<summary><strong>All 193 brands</strong> — camera count &amp; market segment (click to expand)</summary>
...
|-------|---------|---------|
| Dahua | 2,202 | Enterprise + consumer, global |
| Hikvision | 2,162 | Enterprise + consumer, global |
| ACTi | 712 | Enterprise IP + analog, NDAA, TW/global |
| Hanwha | 712 | Enterprise AI, Korea/global |
| i-PRO | 637 | Enterprise AI (ex-Panasonic), JP/global |
| Intelbras | 629 | #1 Latin America, BR/AR/LATAM |
| Uniview | 609 | Enterprise NDAA, global |
| Pelco | 573 | Enterprise legacy, NA/global |
| Avigilon | 517 | Enterprise NDAA, global |
| Axis | 506 | Enterprise premium, global |
| Mapesen | 459 | OEM/budget IP + analog, CN/global |
| Vivotek | 457 | Enterprise AI, global |
| TVT | 435 | Prosumer budget, CN/IN/SE Asia |
| Sunell | 390 | — |
| HiLook (Hikvision) | 377 | Budget installer, EU/UK/AU |
| LTS | 278 | Prosumer/installer, US |
| Bosch | 273 | Enterprise + thermal, EU/global |
| Milesight | 237 | Prosumer/Enterprise IoT, global |
| Comelit | 231 | Installer IP + door-entry, IT/EU |
| Amcrest | 222 | Prosumer, global |
| AVYCON | 194 | Prosumer/commercial (NDAA), US |
| Safire | 194 | — |
| Alibi | 185 | — |
| Kedacom | 184 | Enterprise, CN/global |
| Tiandy | 181 | Enterprise + prosumer, CN/ME/Africa |
| NOVUS | 178 | Installer IP + analog (AAT), PL/EU |
| HOLOWITS | 176 | — |
| Speco | 166 | Professional/commercial (NDAA), US |
| Trassir | 162 | — |
...
| EZVIZ (Hikvision) | 130 | Consumer, global |
| BEWARD | 126 | — |
| Vikylin | 126 | — |
| Digital Watchdog | 124 | Enterprise NDAA, US |
...
| LILIN | 110 | — |
| Ganz | 109 | Enterprise (CBC Group), JP/US/global |
| HikMicro | 107 | — |
| CP Plus | 105 | India #2 brand, IN |
| Mobotix | 105 | Enterprise GDPR-first, EU |
| IC Realtime | 101 | — |
| Sony | 99 | Professional imaging (IPELA), JP/global |
| Honeywell | 97 | Enterprise, US/IN |
| Jovision | 97 | OEM/consumer (CloudSEE), CN/global |
| Illustra | 95 | — |
| Longse | 93 | OEM/budget, CN/global |
| AVTech | 89 | — |
| Foscam | 89 | Consumer WiFi/PoE, global |
| Avtron | 87 | Enterprise + analog, IN |
| Infinova | 87 | — |
| Urmet | 78 | Prosumer/installer, IT/EU |
| EmpireTech | 76 | — |
| D-Link | 73 | Consumer/SMB, TW/global |
| Dallmeier | 73 | — |
| Lorex | 72 | Consumer NVR systems, CA/US |
| Uniarch (Uniview) | 72 | Budget NDAA sub-brand, global |
| Homaxi | 71 | — |
| Prama | 68 | — |
| JideTech | 67 | Consumer/prosumer PoE, CN/global |
| Infiniti Optics | 62 | — |
| Zavio | 60 | — |
| Bolide | 59 | Professional (NDAA), US |
| Luminys | 58 | — |
...
| eneo | 56 | — |
| Vicon | 56 | — |
| Hiseeu | 53 | Budget consumer kits, CN/global |
| Ubiquiti UniFi | 53 | Prosumer/SMB, US/global |
| Eufy (Anker) | 52 | Consumer no-subscription, global |
| Turing | 49 | — |
| Vstarcam | 47 | — |
| Verkada | 44 | Cloud-managed enterprise, US/CA |
| Yudor | 44 | — |
| Vitek | 43 | — |
| ZKTeco | 42 | — |
| Panasonic | 41 | — |
| OpenEye | 40 | — |
| ClareVision | 39 | Custom-install (SnapAV), US |
...
| Costar | 33 | Enterprise (Arecont successor), US |
...
│   ├── dahua/            # 2202 cameras
│   ├── hikvision/        # 2162 cameras
│   ├── acti/             # 712 cameras
│   ├── hanwha/           # 712 cameras
│   ├── i-pro/            # 637 cameras
│   ├── intelbras/        # 629 cameras
│   └── …187 more brands
├── data/                 # GENERATED — do not edit by hand
│   ├── cameras.json      # all 21,406 cameras as one array
...
- [ ] **Backfill pixel resolution** for the ~1,314 entries that state megapixels but no width×height (#169)
- [ ] **Frigate verification drive** — only 1,300 of 16,717 shipped configs are community-verified; [confirm one you run](../../issues/new?template=verify-frigate-config.yml)
...
```
CCTV Camera Database (v2.23.0), CC0 1.0. https://cctv-database.com — https://github.com/ch-bas/cctv-camera-database
```
