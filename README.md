...
An open, structured database of 3,343 CCTV / IP camera models and their technical specifications, covering 77 brands across every market segment — from budget consumer WiFi cameras to enterprise PTZ domes and thermal imaging systems. Each camera is a validated JSON file, aggregated into a single queryable dataset (JSON + CSV).

[![cameras](https://img.shields.io/badge/cameras-3%2C343-blue)](data/cameras.json)
...
- **Pagination** — page through all 3,343 cameras, 25 per page
...
│   ├── cameras.json      # all 3,343 cameras as one array
...
| 4–5MP | 1,367 |
| 1080p–2MP | 1,047 |
| With integration configs (Frigate / Home Assistant) | 2,868 |
| With color-lux rating (`night_vision.min_lux_color`) | 2,124 |
